...
class Percona <Formula
  homepage 'http://www.percona.com/downloads/Percona-Server-5.1/LATEST/'
  url 'http://www.percona.com/downloads/Percona-Server-5.1/Percona-Server-5.1.54-12.5/source/Percona-Server-5.1.54-rel12.5.tar.gz'
  md5 'd22555be32587aad25d07071765c2e67'
  version '5.1.54'
